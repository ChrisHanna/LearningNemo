...
SYSTEM_CAPABILITIES: dict[str, Any] = {
    ...
    "requestStages": [
        ...
        },
        {
            ...
            "owner": "Task agent",
            "icon": "wrench",
            "action": "An authorized tool reads or changes task state; direct answers skip this stage.",
            "evidence": "Tool input and output are visible in NeMo verbose logs",
        },
        {
            "id": "model-response",
        ...
        },
        {
            ...
            "owner": "Local UI",
            "icon": "message-square",
            "action": "Returns assistant text, HTTP status, scope names, and total duration.",
